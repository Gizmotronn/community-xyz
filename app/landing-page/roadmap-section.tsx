...
export function RoadmapSection() {
    ...
    return (
        <section id="roadmap" className="relative w-full py-12 sm:py-16 md:py-20 lg:py-24 bg-transparent overflow-hidden">
            <div className="container mx-auto px-6 min-[640px]:px-8 min-[768px]:px-10 min-[1024px]:px-12 relative z-10">
                <h2
                ...
                <div ref={containerRef} className="w-full max-w-[1400px] mx-auto px-8 min-[640px]:px-10 min-[768px]:px-12 min-[1024px]:px-16 min-[1280px]:px-20 min-[1400px]:px-8">
